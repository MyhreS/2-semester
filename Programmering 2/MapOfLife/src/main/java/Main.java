...
/*
        ...
        Observation nr1 = new Observation(1, "Sparrow", sparrow, LocalDate.now(), 1, "http", locationEarth, "Look at this!");
        Observation nr2 = new Observation(2, "Wolf", wolf, LocalDate.now(), 6, "http", locationJupiter, "Sometime you have to look at this!");
        Observation nr3 = new Observation(3, "Duck", duck, LocalDate.now(), 2, "http", locationMars, "Dont look at this!");
        Observation nr4 = new Observation(4, "Dog", dog, LocalDate.now(), 11, "http", locationEarth, "Maybe look at this!");
        Observation nr5 = new Observation(5, "Cat", cat, LocalDate.now(), 2, "http", locationMars, "Never look at this!");
        Observation nr6 = new Observation(6, "Snake", snake, LocalDate.now(), 6, "http", locationJupiter, "Never ever look at this!");
        list.add(nr1);
        list.add(nr2);
        list.add(nr3);
        list.add(nr4);
        ...
        Observation nr8 = new Observation(8, "Snake", snake, LocalDate.now(), 6, "http", locationJupiter, "Never ever look at this!");
        ...
        //Edit observation -------------------------------
        Observation nr8 = new Observation(7, "DangerSnake", snake, LocalDate.now(), 6, "http", locationJupiter, "Never ever look at this!");
        ...
        */
        ...
        app.before("/", ctx -> ctx.redirect("/api/observations"));
