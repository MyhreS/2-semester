package no.hiof.simonmy.oblig5.model;
...
public class Planet extends NaturalSatellite {
    ...
    public void editAPlanetObject(Planet planetInput) {
        this.setName(planetInput.getName());
        this.setMass(planetInput.getMass());
        this.setRadius(planetInput.getRadius());
        this.setSemiMajorAxis(planetInput.getSemiMajorAxis());
        this.setEccentricity(planetInput.getEccentricity());
        this.setOrbitalPeriod(planetInput.getOrbitalPeriod());
        this.setCentralCelestialBody(planetInput.getCentralCelestialBody());
        this.setPictureUrl(planetInput.getPictureUrl());
    }
