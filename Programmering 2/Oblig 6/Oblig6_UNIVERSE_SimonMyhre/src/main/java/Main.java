 ...
 */
        ...
        */
        ...
        app.get("/observations/:observations-id", new VueComponent("observations-detail"));

        app.get("api/observations", mapOfLifeController::getObservations);

        app.get("api/observations/:observations-id", mapOfLifeController::getObservation);

        app.get("/api/observations/:observations-id/delete", mapOfLifeController::deleteAObservation);
